...
### Memorização e vazamento de solução `[Validade Interna]`

**Descrição:** Em katas muito conhecidos, o assistente de IA pode reproduzir uma solução memorizada em vez de efetivamente auxiliar na resolução, inflando artificialmente o desempenho do tratamento WITH_AI.
